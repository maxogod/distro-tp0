...
insert_client_services() {
    for ((i=1; i<=num_clients; i++)); do
        ...
        content+="$(indent_string 3 "- CLI_NOMBRE=First$i")\n"
        content+="$(indent_string 3 "- CLI_APELLIDO=Last$i")\n"
        content+="$(indent_string 3 "- CLI_DOCUMENTO=$i")\n"
        content+="$(indent_string 3 "- CLI_NACIMIENTO=2003-06-18")\n"
        content+="$(indent_string 3 "- CLI_NUMERO=$i")\n"
        content+="$(indent_string 2 "volumes:")\n"
