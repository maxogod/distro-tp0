...
insert_client_services() {
    for ((i=1; i<=num_clients; i++)); do
        ...
        content+="$(indent_string 3 "- NOMBRE=First$i")\n"
        content+="$(indent_string 3 "- APELLIDO=Last$i")\n"
        content+="$(indent_string 3 "- DOCUMENTO=$i")\n"
        content+="$(indent_string 3 "- NACIMIENTO=2003-06-18")\n"
        content+="$(indent_string 3 "- NUMERO=$i")\n"
        content+="$(indent_string 2 "volumes:")\n"
